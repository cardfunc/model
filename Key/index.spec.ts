...
describe("Key", () => {
	...
	const testKeys = {
		// All keys below are signed with test-system values for apiKeySecret, apiKeySecretV1, propertySecret or propertySecretV1.
		payfunc: {
			V1: {
				// The two keys below are signed with apiKeySecret and propertySecret, with an internal card-JWT signed with apiKeySecretV1 and propertySecretV1.
				public:
			...
			// The two keys below are signed with apiKeySecret and propertySecret.
			public:
		...
		cardfunc: {
			V1: {
				// The two keys below are signed with apiKeySecretV1 and propertySecretV1.
				public:
